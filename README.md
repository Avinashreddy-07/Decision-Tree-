...
2. Split the data into training (80%) and testing (20%) sets using `train_test_split`.
3. Trained **DecisionTreeClassifier** with `max_depth` values 1, 2, and 3.
4. Predicted on training and testing data, calculated **accuracy**.
5. Stored results in a pandas DataFrame and compared the performance.
